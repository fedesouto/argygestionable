...
function automobile_hub_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'automobile_hub_tp_color_option', array(
  	...
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'automobile_hub_tp_color_option', array(
			'label'     => __('Theme Color', 'automobile-hub'),
  	...
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'automobile_hub_tp_color_option_link', array(
			'label'     => __('Theme Hover Link Color', 'automobile-hub'),
   ...
   $wp_customize->add_control('automobile_hub_tp_body_layout_settings',array(
	...
	$wp_customize->add_section('automobile_hub_blog_option',array(
		...
		$wp_customize->add_control( new Automobile_Hub_Toggle_Control( $wp_customize, 'automobile_hub_remove_date', array(
			'label'       => esc_html__( 'Show / Hide Date Option', 'automobile-hub' ),
			'section'     => 'automobile_hub_blog_option',
			'type'        => 'toggle',
			'settings'    => 'automobile_hub_remove_date',
		) ) );
    ...
    $wp_customize->selective_refresh->add_partial( 'automobile_hub_remove_date', array(
		...
		$wp_customize->add_control( new Automobile_Hub_Toggle_Control( $wp_customize, 'automobile_hub_remove_author', array(
			'label'       => esc_html__( 'Show / Hide Author Option', 'automobile-hub' ),
			'section'     => 'automobile_hub_blog_option',
			'type'        => 'toggle',
			'settings'    => 'automobile_hub_remove_author',
		) ) );
    ...
    $wp_customize->selective_refresh->add_partial( 'automobile_hub_remove_author', array(
		...
		$wp_customize->add_control( new Automobile_Hub_Toggle_Control( $wp_customize, 'automobile_hub_remove_comments', array(
			'label'       => esc_html__( 'Show / Hide Comment Option', 'automobile-hub' ),
			'section'     => 'automobile_hub_blog_option',
			'type'        => 'toggle',
			'settings'    => 'automobile_hub_remove_comments',
		) ) );
